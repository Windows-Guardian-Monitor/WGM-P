import {ArticleText, Content} from "./style";
import TextContent from "./TextContent";

export default function ThirthContent() {
	return (
		<Content>
			<h2>O que vamos ter</h2>
			<h3>
				WGM pode ser o q voce precisar que ela seja, nao somente um
				bloqueador, pode ser coisas mais legais, talvez um ant virus
			</h3>
			<ArticleText>
				<TextContent
